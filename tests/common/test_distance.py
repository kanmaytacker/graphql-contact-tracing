...
def test_same_location(input_data: Tuple[Tuple[float], Tuple[float, float]], expected: int) -> None:
...
def test_haversine(input_data: Tuple[Tuple[float], Tuple[float, float]], expected: int) -> None:
